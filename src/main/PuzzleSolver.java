...
//    final static String PUZZLE_TYPE = "globe_1/8";
    ...
    public static void main(String[] args) {
        ...
        int maxChanges = (int)(puzzlesToUse.get(0).getInitialState().length * 2.0 / 4.0);
        PermutationChecker explorer = new CubePermutationChecker(puzzlesToUse, puzzleInfoToUse, MAX_DEPTH, 1);
    ...
    public static void validateSolution(Puzzle puzzle, PuzzleInfo puzzleInfo, List<Move> moves) {
        ...
        PermutationChecker checker = new PermutationChecker(Arrays.asList(puzzle), puzzleInfo, 1, MAX_CHANGES);
        for (Move move : moves) {
